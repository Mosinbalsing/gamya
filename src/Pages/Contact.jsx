...
export default function ContactForm() {
  ...
  return (
    <div className="container-fluid mx-auto px-4 overflow-hidden">
      <Banner src={src}/>
          ...
          <div className="space-y-2">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                Flat No.1, Yugmanest Building, Shinde Ali, 169, Shukrawar Peth, Near Kelkar Museum, Pune (Municipal Corporation.), Pune City, Pune, 411002
                </address>
              </div>
            </div>
          </div>
